...
import com.ald.stat.cache.{AbstractRedisCache, CacheClientFactory, CacheFactory, CacheRedisFactory, ClientRedisCache, RedisCache}
...
object RawOperation {
  ...
  lazy val redisClient: AbstractRedisCache = CacheRedisFactory.getInstances.asInstanceOf[AbstractRedisCache]
  lazy val clientRedisClient: AbstractRedisCache = CacheRedisFactory.getInstances.asInstanceOf[AbstractRedisCache]

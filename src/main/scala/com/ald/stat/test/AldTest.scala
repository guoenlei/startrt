...
import com.ald.stat.cache.CacheRedisFactory
...
object AldTest extends App {
      ...
      val redis =CacheRedisFactory.getInstances("default")
      val redis1 =CacheRedisFactory.getInstances("trend_offset")
//  val redisCache = CacheRedisFactory.getInstances("default").asInstanceOf[AbstractRedisCache]
//  val redisCache = CacheClientFactory.getClusterInstancesFromProperties("default")
//
//  redisCache.set("test","111111111111111",0)
//  val value = redisCache.get("test")
//  println(value)
//

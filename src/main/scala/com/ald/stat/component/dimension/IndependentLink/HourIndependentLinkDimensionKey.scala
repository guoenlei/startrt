...
/**
  ...
  */
////////////小时级别最基本的抽象类，包括当日和站点
class HourIndependentLinkDimensionKey(logRecord: LogRecord) extends DimensionKey(logRecord: LogRecord) {
...
object HourIndependentLinkDimensionKey extends KeyTrait[LogRecord, DimensionKey] {
  ...
  def getKey(logRecord: LogRecord): DimensionKey = new HourIndependentLinkDimensionKey(logRecord)
}

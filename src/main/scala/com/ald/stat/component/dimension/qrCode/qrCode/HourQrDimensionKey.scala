...
import com.ald.stat.utils.ComputeTimeUtils
  ...
  class HourQrDimensionKey(logRecord: LogRecord) extends DimensionKey(logRecord) {
    ...
    override val key: String = logRecord.ak + ":" + logRecord.te + ":" + dayAndHour._1 + ":" + dayAndHour._2 + ":" + logRecord.qr
  }
  object HourQrDimensionKey extends KeyTrait[LogRecord,DimensionKey]{

    override def getKey(c: LogRecord): DimensionKey = new HourQrDimensionKey(c)
  }

 ...
 */
class HourIndependentLinkDimensionKeyNewAdMonitor(logRecord: LogRecord) extends DimensionKey(logRecord: LogRecord) {
...
object HourIndependentLinkDimensionKeyNewAdMonitor extends KeyTrait[LogRecord, DimensionKey] {
  ...
  def getKey(logRecord: LogRecord): DimensionKey = new HourIndependentLinkDimensionKeyNewAdMonitor(logRecord)
}
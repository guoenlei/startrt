 ...
 * @author guo
 */
class HourLinkMediaPositionImgOpenidSubDimensionKeyNewAdMonitor(logRecord: LogRecord) extends SubDimensionKey(logRecord: LogRecord) {
...
object HourLinkMediaPositionImgOpenidSubDimensionKeyNewAdMonitor extends KeyParentTrait[LogRecord,SubDimensionKey,DimensionKey]{
  ...
  override def getKey(c: LogRecord): SubDimensionKey = new HourLinkMediaPositionImgOpenidSubDimensionKeyNewAdMonitor(c)
}
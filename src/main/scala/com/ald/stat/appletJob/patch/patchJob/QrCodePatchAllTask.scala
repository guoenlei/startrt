package com.ald.stat.appletJob.patch.patchJob

import java.util

import com.ald.stat.appletJob.task.TaskTrait
import com.ald.stat.component.dimension.qrCode.qrCode._
import com.ald.stat.component.dimension.qrCode.qrGroup._
...
@Deprecated
object QrCodePatchAllTask extends TaskTrait{
  ...
  def qrDailyStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //session处理
    val sessionRDD = QrDailySessionStat.statPathSession(baseRedisKey, taskId, dateStr, tempSessMergeResult, DailyQrSessionSubDimensionKey, redisPrefix)
    //扫码总人数 uv
    val pvRDD = QrDailyUVStat.statPatchPV(baseRedisKey, dateStr, DailyQrDimensionKey, logRecordRdd, redisPrefix)

    val uvRDD = QrDailyUVStat.statPatchUV(baseRedisKey, dateStr, DailyQrUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def qrHourStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //session处理
    val sessionRDD = QrHourSessionStat.statPathSession(baseRedisKey, taskId, dateStr, tempSessMergeResult, HourQrSessionSubDimensionKey, redisPrefix)
    //扫码总人数 UV
    val pvRDD = QrHourUVStat.statPatchPV(baseRedisKey, dateStr, HourQrDimensionKey, logRecordRdd, redisPrefix)

    val uvRDD = QrHourUVStat.statPatchUV(baseRedisKey, dateStr, HourQrUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def qrGroupDailyStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //session处理
    val sessionRDD = QrGroupDailySessionStat.statPathSession(baseRedisKey, taskId, dateStr, tempSessMergeResult, DailyQrGroupSessionSubDimensionKey, redisPrefix)
    //扫码总人数 UV
    val pvRDD = QrGroupDailyUVStat.statPatchPV(baseRedisKey, dateStr, DailyQrGroupDimensionKey, logRecordRdd, redisPrefix)

    val uvRDD = QrGroupDailyUVStat.statPatchUV(baseRedisKey, dateStr, DailyQrGroupUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def qrGroupHourStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //session处理
    val sessionRDD = QrGroupHourSessionStat.statPathSession(baseRedisKey, taskId, dateStr, tempSessMergeResult, HourQrGroupSessionSubDimensionKey, redisPrefix)
    //扫码总人数 UV
    val pvRDD = QrGroupHourUVStat.statPatchPV(baseRedisKey, dateStr, HourQrGroupDimensionKey, logRecordRdd, redisPrefix)

    val uvRDD = QrGroupHourUVStat.statPatchUV(baseRedisKey, dateStr, HourQrGroupUidSubDimensionKey, logRecordRdd, redisPrefix)

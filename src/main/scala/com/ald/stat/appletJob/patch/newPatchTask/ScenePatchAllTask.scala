...
object ScenePatchAllTask extends TaskTrait{
  ...
  def hourlyStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //uv
    val pvRDD = SceneHourUVStat.statPatchSubPV(baseRedisKey, dateStr, HourSceneDimensionKey, logRecordRdd, redisPrefix, patchHour, prefix)

    val uvRDD = SceneHourUVStat.statPatchUVNew(baseRedisKey, dateStr, HourSceneUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def hourlyGroupStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //uv
    val pvRDD = SceneGroupHourUVStat.statPatchSubPV(baseRedisKey, dateStr, HourSceneGroupDimensionKey, logRecordRdd, redisPrefix,patchHour,prefix)

    val uvRDD = SceneGroupHourUVStat.statPatchUVNew(baseRedisKey, dateStr, HourSceneGroupUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def dailyStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //uv
    val pvRDD = SceneDailyUVStat.statPatchSubPV(baseRedisKey, dateStr, DailySceneDimensionKey, logRecordRdd, redisPrefix,patchHour,prefix)

    val uvRDD = SceneDailyUVStat.statPatchUVNew(baseRedisKey, dateStr, DailySceneUidSubDimensionKey, logRecordRdd, redisPrefix)
  ...
  def dailyGroupStat(baseRedisKey: String, taskId: String, dateStr: String, logRecordRdd: RDD[LogRecord],
    ...
    //uv
    val pvRDD = SceneGroupDailyUVStat.statPatchSubPV(baseRedisKey, dateStr, DailySceneGroupDimensionKey, logRecordRdd, redisPrefix,patchHour,prefix)

    val uvRDD = SceneGroupDailyUVStat.statPatchUVNew(baseRedisKey, dateStr, DailySceneGroupUidSubDimensionKey, logRecordRdd, redisPrefix)

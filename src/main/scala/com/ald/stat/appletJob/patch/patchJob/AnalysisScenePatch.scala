...
import com.ald.stat.appletJob.patch.AnalysisScenePatch.{cacheGrapUser, handleNewUserForOldSDK, isOnline, markNewUser}
import com.ald.stat.appletJob.patch.patchTask.ScenePatchAllTask

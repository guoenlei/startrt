...
import com.ald.stat.cache.{AbstractRedisCache, BaseRedisCache, CacheClientFactory, CacheRedisFactory, ClientRedisCache}
...
trait EntrancePageSessionStat extends EntrancePageStatBase {
  ...
  (baseRedisKey: String, dateStr: String, resource: BaseRedisCache, record: (K, O), k: KeyParentTrait[C, K, P]): (P, EntrancePageSessionSum, P, EntrancePageSessionSum) = {
